...
<body>
    ...
    <section id="about" class="section">
        <div class="container">
            <div class="flex flex-col items-center">
                <div class="pill-box w-full max-w-2xl">
                    <h2>About Us - Secure Sales Representatives LLC.</h2>
                </div>
                <div class="text-box w-full max-w-2xl">
                    <p>
    ...
    <section id="experience" class="section">
        <div class="container">
            <div class="flex flex-col items-center">
                <div class="pill-box w-full max-w-md">
                    <h2>Professional Experience</h2>
                </div>
                <div class="text-box w-full max-w-2xl">
                    <div class="space-y-6 text-left">
                        <div class="border-bottom">
                            <h3>Senior Consultant Leader</h3>
        ...
        <div class="container">
            <div class="flex flex-col items-center">
                ...
                <div class="text-box w-full max-w-2xl">
                    <div class="space-y-6 text-left">
                        <div class="border-bottom">
                            <h3>Master of Systems Infrastructure and Communications - Con. Cybersecurity</h3>
                        ...
                        <div>
                            <h3>Bachelor of Marketing - Con. Real Estate</h3>
    ...
    <section id="contact" class="section">
        <div class="container">
            <div class="flex flex-col items-center">
                ...
                <div class="text-box w-full max-w-2xl">
                    <div class="space-y-6">
                        <h3 class="text-2xl mb-6">Schedule Your Change Today.</h3>
                        <div class="contact-grid">
                            ...
                            <div class="contact-item">
                                <svg class="icon text-pink-500" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8z"/>
                                ...
                                <a href="https://www.instagram.com/securesalesrepresentatives" target="_blank" class="underline">Instagram</a>
                            </div>
                            <div class="contact-item">
                                <svg class="icon text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"/>
                                </svg>
                                <a href="https://x.com/SecureSalesReps" target="_blank" class="underline">Twitter (X)</a>
                            </div>
                            <div class="contact-item">
                                <svg class="icon text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/>
                                </svg>
                                <a href="https://linktr.ee/securesalesrepresentatives" target="_blank" class="underline">Linktree</a>
                            </div>
                        </div>
                        <div class="mt-8">
                            <p class="text-sm mb-4">We Value Your Time. Contact The Head Representative Today. All Rights Reserved. 2025 Secure Sales Representatives (SSR) LLC.</p>
                            <a href="mailto:zjordonez@gmail.com" class="btn">
                                Send Message
